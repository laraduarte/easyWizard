...
function EasyWizard() {
    ...
    var previousStepIndex                 // Previous Step Index
    ...
    var go = function() {
        ...
        var nextStep = function() {
            ...
            // Pausing wizard
            if ( currentStep.getPause() != true  || previousStepIndex == currentStepIndex ) emitter.emit('continue')
    ...
    var getCurrentStep = function getCurrentStep() { return previousStepIndex }

    var setNextStep = function setNextStep(forcedNextStep) { 
        steps[currentStepIndex].NextSetp = forcedNextStep 
    }
