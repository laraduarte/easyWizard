...
function EasyWizard() {
    ...
    var go = function() {
        ...
        if ( currentStepIndex === null || currentStepIndex === undefined ) return
        if (currentStep == undefined) throw unknownStepError
        console.log("\nGo! Current Step " + currentStep.getId())   

        // Saving answer, updating current Step function, pausing wizard if it is required...
        var nextStep = function() {
            ...
            if ( nextStep === null || nextStep === undefined ) return
